...
const handleDelete = (row: GetTableData) => {
  ElMessageBox.confirm(`正在删除管理人员：${row.username}，确认删除？`, "提示", {
  ...
  <div class="app-container">
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-button type="primary" :icon="CirclePlus" @click="dialogVisible = true">新增管理人员</el-button>
      ...
      <div class="table-wrapper">
        <el-table :data="tableData">
          ...
          <el-table-column prop="username" label="管理人员姓名" align="center" />
    ...
    <el-dialog
      ...
      :title="currentUpdateId === undefined ? '新增管理人员' : '修改管理人员'"
      @close="resetForm"
      width="30%"
    >
